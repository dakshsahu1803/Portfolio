  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-text-primary">EDUCATION</h2>
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    <h3 className="text-xl sm:text-xl font-semibold text-text-primary">
                      {edu.degree}
                    </h3>
                  ...
                  {/* Date at the bottom */}
                  <p className="text-sm text-text-secondary/80 mt-2">{edu.date}</p>
                </div>
              </div>

              <p className="mt-4 text-text-secondary font-bold">Grade: {edu.grade}</p>
              <p className="mt-4 text-text-secondary">{edu.desc}</p>
            </div>
          </div>
        ))}
      </div>
